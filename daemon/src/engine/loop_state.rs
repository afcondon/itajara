...
pub struct Loop {
    ...
    pub(crate) l_len: Vec<AtomicUsize>,
    ...
    pub(crate) l_tail: Vec<AtomicUsize>,
    ...
    pub(crate) l_born: Vec<AtomicI64>,
    ...
    /// here at all.
    pub(crate) env: Mutex<Vec<Vec<u8>>>,
    ...
    pub(crate) l_gain: Vec<AtomicU32>,
    ...
    pub(crate) l_win_in: Vec<AtomicI64>,
    pub(crate) l_win_out: Vec<AtomicI64>,
    pub(crate) l_period: Vec<AtomicUsize>,
    pub(crate) l_phase: Vec<AtomicUsize>,
